...
public class GraphDBOperator extends RetryWithToleranceOperator implements OperationHandler {
	public static final long DEFAULT_RETRY_BACKOFF = 100L;
	...
	private static final long DELAY = getFromPropertyOrDefault(CommonClientConfigs.RETRY_BACKOFF_MS_CONFIG, DEFAULT_RETRY_BACKOFF);
	...
	private static class GraphDBErrorHandlingMetrics extends ErrorHandlingMetrics {
		public static final String OFFSET_FILE = "/tmp/connect.offsets";
		...
		private static Map<String, String> getBasicProperties() {
			...
			props.put(StandaloneConfig.OFFSET_STORAGE_FILE_FILENAME_CONFIG, OFFSET_FILE);
			return props;
		}
	}
}
