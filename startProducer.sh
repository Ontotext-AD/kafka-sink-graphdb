...
#java -cp kafka-clients.jar:slf4j-api.jar:slf4j-simple.jar:kafka-sink-graphdb.jar com/ontotext/kafka/producer/GraphDBProducer /home/vasil/kafka_2.13-2.8.0/config/graphdb-producer.properties graphdb testKafka.ttl testKafka1.ttl
